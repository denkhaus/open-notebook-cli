...
func NewSourceService(injector do.Injector) (SourceService, error) {
	repo := do.MustInvoke[SourceRepository](injector)
...
func (s *sourceService) Repository() SourceRepository {
	return s.repo
}
